        ...
        <div className="grid grid-cols-3">
            <div className="grid col-span-2 h-screen flex justify-center items-center bg-gradient-to-r from-gray-400 to-gray-600 relative">
                ...
                <pre className="text-center font-medium text-2xl text-yellow-200 font-serif">
                    ...
                    <span className="text-zinc-300">AI-powered mathematical visualizations
                    <br />
                    Create stunning math visualizations with AI <br /><br />
                    - Crafted by Govind</span>
            ...
            <div className="grid col-span-1 h-screen flex justify-center items-center">
                <div className="max-w-md space-y-8 h-fit w-fit p-9 border rounded-t-xl shadow-xl">
                    <div>
                        <h2 className="mt-6 text-center text-3xl font-bold px-4 text-gray-900">
                            Create your account
                        </h2>
                    </div>
                    <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                        ...
                        <span className="mt-4 text-amber-500 text-sm text-sans text-right">Already have an account ? <Link to="/login" className="font-medium underline">LogIn</Link></span>
                    </form>
                </div>
            </div>
        </div>
